...
const gameName = new String('Vikky_Verma-JI') 
...
console.log(gameName.indexOf('V')) // used to know the index of the char
...
console.log(url.includes('Vikky')) //this is to check whether the given char is present in the url 
